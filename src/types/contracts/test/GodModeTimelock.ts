...
export interface GodModeTimelockInterface extends utils.Interface {
  functions: {
...
export interface GodModeTimelock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GodModeTimelockInterface;
